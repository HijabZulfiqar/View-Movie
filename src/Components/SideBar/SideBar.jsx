  ...
  return (
    <div className=" ">
      <Disclosure>
        ...
        {isSidebarOpen && (
          <div
            className={`p-6 h-screen bg-[#232533] z-20 md:z-0 fixed lg:relative top-0 -left-96 lg:left-0 w-60 peer-focus:left-0 peer:transition ease-out delay-150 duration-200`}
          >
